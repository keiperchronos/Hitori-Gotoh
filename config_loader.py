...
DEFAULT_CONFIG = {
    ...
    "SOURCE_REPO": "https://github.com/keiperchronos/Hitori-Gotoh.git",
    "SUPPORT_SERVER": "",
    "ADDITIONAL_BOT_IDS": "",
    ...
    "LAVALINK_SERVER_LIST": "https://gist.githubusercontent.com/keiperchronos/f90d1ba3b297ae21fbef2210d3939a3e/raw/lavalink.ini",
    ...
    "LAVALINK_FILE_URL": "https://github.com/keiperchronos/bin-rios/releases/download/lavalink/Lavalink.jar",
    ##########################
    ##### Bot presences: #####
    ##########################
    "LISTENING_PRESENCES": "",
...
def load_config():
    ...
    CONFIG["RPC_SERVER"] = CONFIG["RPC_SERVER"].replace(
        "$PORT", CONFIG.get("PORT") or environ.get("PORT", "80")
    )
